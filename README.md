...
- текстовый чат комнаты с сохраняемой историей и мгновенными обновлениями;
...
API никогда не проксирует аудио или демонстрацию экрана. Он проверяет cookie-сессию, управляет комнатами и сохраняет сообщения в PostgreSQL, доставляя уведомления о новых сообщениях через SSE. Для медиасессии API выпускает LiveKit JWT на 10 минут.
